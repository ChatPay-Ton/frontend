...
interface UserContextType extends UserTypeData {
  ...
  currentScreen: 'login' | 'user-type-selection' | 'client-registration' | 'provider-registration' | 'client-dashboard' | 'provider-dashboard' | 'search' | 'client-contracts' | 'provider-contracts';
